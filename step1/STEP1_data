...
def process_file(file_path):
    try:
        ...
        # 所有可能的特征
        columns_to_select = [
            'year', 'month', 'day', 'hour', 'quarter', 'day_night_category', 'X', 'Y', '4天候', 
            '5光線', '6道路類別', '7速限', '8道路型態', '9事故位置',  '15事故類型及型態', 
            '外國人', '性別', '肇因碼-個別', '處理別', '案號', '死亡人數', '2-30日死亡人數', '受傷人數',
            '當事人序', '車種', '肇因碼-主要', '10路面狀況1', '10路面狀況2', '10路面狀況3', 
            '11道路障礙1', '11道路障礙2', '12號誌1', '12號誌2', '13車道劃分-分向', 
            '14車道劃分-分道1', '14車道劃分-分道2', '14車道劃分-分道3', '重大車損', 
            '年齡', '22受傷程度', '23主要傷處', '25行動電話', '28車輛用途', '29當事者行動狀態', 
            '30駕駛資格情形', '31駕駛執照種類', '32飲酒情形', '33_1主要車損', '33_2其他車損', 
            '35個人肇逃否', '36職業', '37旅次目的', '區'
        ]
        ...
        # 重命名列
        new_columns = [
            'year', 'month', 'day', 'hour', 'quarter', 'day_night_category', 'X', 'Y', 'weather', 
            'light', 'road_type', 'speed_limit', 'road_form', 'accident_location', 'accident_type', 
            'foreigner', 'gender', 'cause_code_individual', 'processing_type', 'case_number', 
            'death_count', 'death_within_2_30_days', 'injury_count', 'party_sequence', 'vehicle_type', 
            'cause_code_main', 'road_condition_1', 'road_condition_2', 'road_condition_3', 
            ...
            'major_vehicle_damage_1', 'other_vehicle_damage', 'hit_and_run', 'occupation', 
            'trip_purpose', 'district'
        ]
